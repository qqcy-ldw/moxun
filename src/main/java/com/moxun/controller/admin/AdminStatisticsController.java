...
public class AdminStatisticsController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping("/trend")
    public Result<TrendStatisticsVo> getTrendStatistics(@Validated @RequestBody StatisticsDto statisticsDto) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping("/rank")
    public Result<Map<String, String>> getRankStatistics(@Validated @RequestBody StatisticsDto statisticsDto) {
        HashMap<String, String> data = adminStatisticsService.getRankStatistics(statisticsDto);
        return Result.success(data);
    }
